...
#### --> PRACTICAL
[[Practical - Linux Priv-Esc#TASK 8 - CAPABILITIES]].

# TASK 9 - PRIV-ESC : CRON JOBS
#cron 
This task helps you understand how you can use different kinds of `cron jobs` to escalate your privileges within a system(Linux of course, DUH!).
>A cron job is a scheduled task that runs on a regular basis. It is managed by the cron daemon (`crond`), which reads configuration files known as crontabs. 
>For more, refer to [[CRON JOBS]], or if you want you can do your own research, which I always suggest, is more beneficial for your own understanding!

Multiple users, having their own cron tasks, running behind the scenes, whether they are logged in or not, whether **the file even exists or not**!

You'll get a better understanding of it with the `practical`.
#### --> PRACTICAL
[[Practical - Linux Priv-Esc#TASK 9 - CRON JOBS]].

# TASK 10 - PRIV-ESC : PATH
#env 
The only thing I can say about this task is, *only go forward with it, once you have gathered enough patience*.
You could be a genius, but not everybody is, and for those who are **NOT**, it's gonna some time to **understand** what the room is *trying to tell you*, and what you are *actually supposed to do*!
But what this [task](https://tryhackme.com/r/room/linprivesc) basically means is in the first line of it! If you understand that, knowing what to do won't be a problem, **HOW** to do it could be.

#### --> PRACTICAL
[[Practical - Linux Priv-Esc#TASK 10 - PATH]].

# TASK 11 - PRIV-ESC : NFS

Now this here, is quite a big change of pace as compared to before. Till now, we have been using `internal accesses` as priv-esc vectors, but we have more than that!
- Finding root SSH private keys, and connecting directly with root privileges.
- Misconfigured network shell - more inclined towards CTF's and exams.
- NFS (Network File Sharing) - created during NFS server installation.

This was one heck a room, I did tasks 1-10 in like 3-4, 5 days tops, task 11 itself took me 4-5 days. Not my fault, I had some technical issues at my end as well. If you face any, I'd suggest use the `Attack Box` instead.
#### --> PRACTICAL
[[Practical - Linux Priv-Esc#TASK 11 - NFS]]

# TASK 12 - CAPSTONE CHALLENGE
This challenge was nothing compared to what we have been doing so far so. not much to say here.
#### --> PRACTICAL
[[Practical - Linux Priv-Esc#TASK 12 - CAPSTONE CHALLENGE]].
